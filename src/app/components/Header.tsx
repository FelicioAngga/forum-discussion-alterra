  ...
  return (
    <div className="px-6 py-5 flex justify-between bg-[#262D34]">
      ...
      <div className="md:flex-1 mx-auto">
        <div className="relative bg-[#2C353D] md:w-fit mx-auto rounded-lg">
          <input type="text" className="xl:min-w-[400px] w-40 rounded-lg px-4 pr-10 py-3 text-sm bg-[#2C353D] placeholder:text-[#858EAD]" placeholder="Search..." />
